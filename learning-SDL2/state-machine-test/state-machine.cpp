...
bool init()
{
	...
	{
		//Create window
		window = SDL_CreateWindow( "state machine Tutorial", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
		if( window == NULL )
		{
...
//     //Set up the screen
//     SDL_Window *window = SDL_CreateWindow("My Game Window", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 640, 480, SDL_WINDOW_FULLSCREEN | SDL_WINDOW_OPENGL);
...
{
    //Load the dot image
    dot = load_image( "../resources/dot.bmp" );
    ...
    //Open the font
    font = TTF_OpenFont( "../resources/lazy.ttf", 36 );
